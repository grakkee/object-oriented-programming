//Grace Meredith
//CS202 Project 8: Adventure Game
//12 August 2020
...
int main(){
	int chestChoice, bagChoice, fightOrFlee, pullSword; 
	string playerName; 
	Player player1;
	Orc badGuy1;
...
int pullSword(Player& player1){
	...
	cout << endl;
	cout << "As you pass a rock, you notice a sword sticking out of it." << endl;
	cout << "You you pull it out?" << endl;
	cout <<"1 - yes 2 - no" << endl;
	cin >> userChoice; 


	if(userChoice == 1){
		string swordName = "Fingernail of Doom shield";
		int damagePoints = 10;
		int parryPoints = 5;
		Sword player1Sword2;

		cout << "You found the \"Fingernail of Doom\" shield!" << endl << "It causes 10 damage when striking and can block 5 damage when parrying." << endl;
		
		player1Sword2.setName(swordName);
		player1Sword2.setDamage(damagePoints);
		player1Sword2.setParry(parryPoints);
